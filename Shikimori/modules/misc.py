...
MARKDOWN_HELP = f"""
Markdown is a very powerful formatting tool supported by telegram. {SHIKIMORI_PTB.bot.first_name} has some enhancements, to make sure that \
...
def markdown_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
...
SHIKIMORI_PTB.add_handler(ECHO_HANDLER)
SHIKIMORI_PTB.add_handler(MD_HELP_HANDLER)
