...
MARKDOWN_HELP = f"""
Markdown is a very powerful formatting tool supported by telegram. {app_build.bot.first_name} has some enhancements, to make sure that \
...
app_build.add_handler(ECHO_HANDLER)
app_build.add_handler(MD_HELP_HANDLER)
