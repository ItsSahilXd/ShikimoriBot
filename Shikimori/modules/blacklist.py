...
BLACKLIST_DEL_HANDLER = MessageHandler(
    ...
    & constants.ChatType.GROUPS,
    del_blacklist,
    allow_edit=True,
    block=False,
)

SHIKIMORI_PTB.add_handler(BLACKLIST_HANDLER)
SHIKIMORI_PTB.add_handler(ADD_BLACKLIST_HANDLER)
SHIKIMORI_PTB.add_handler(UNBLACKLIST_HANDLER)
SHIKIMORI_PTB.add_handler(BLACKLISTMODE_HANDLER)
SHIKIMORI_PTB.add_handler(BLACKLIST_DEL_HANDLER, group=BLACKLIST_GROUP)
