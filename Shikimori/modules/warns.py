...
def add_warn_filter(update: Update, context: CallbackContext):
    ...
    for handler in SHIKIMORI_PTB.handlers.get(WARN_HANDLER_GROUP, []):
        if handler.filters == (keyword, chat.id):
            SHIKIMORI_PTB.remove_handler(handler, WARN_HANDLER_GROUP)
...
SHIKIMORI_PTB.add_handler(CALLBACK_QUERY_HANDLER)
SHIKIMORI_PTB.add_handler(RESET_WARN_HANDLER)
SHIKIMORI_PTB.add_handler(MYWARNS_HANDLER)
SHIKIMORI_PTB.add_handler(ADD_WARN_HANDLER)
SHIKIMORI_PTB.add_handler(RM_WARN_HANDLER)
SHIKIMORI_PTB.add_handler(LIST_WARN_HANDLER)
SHIKIMORI_PTB.add_handler(WARN_LIMIT_HANDLER)
SHIKIMORI_PTB.add_handler(WARN_STRENGTH_HANDLER)
SHIKIMORI_PTB.add_handler(WARN_FILTER_HANDLER, WARN_HANDLER_GROUP)
