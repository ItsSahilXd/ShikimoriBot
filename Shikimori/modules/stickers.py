...
app_build.add_handler(STICKERS_HANDLER)
app_build.add_handler(STICKERID_HANDLER)
app_build.add_handler(GETSTICKER_HANDLER)
app_build.add_handler(KANG_HANDLER)
app_build.add_handler(DELKANG_HANDLER)
