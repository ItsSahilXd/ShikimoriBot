...
SHIKIMORI_PTB.add_handler(WAIFU_HANDLER)
SWAIFU_HANDLER = CommandHandler('swaifu', swaifu, block=False)
SHIKIMORI_PTB.add_handler(SWAIFU_HANDLER)
SOURCE_HANDLER = CommandHandler('source', source, block=False)
SHIKIMORI_PTB.add_handler(SOURCE_HANDLER)
SHIKIMORI_PTB.add_handler(POUT_HANDLER)
SHIKIMORI_PTB.add_handler(BORED_HANDLER)
SHIKIMORI_PTB.add_handler(NEKOS_HANDLER)
SHIKIMORI_PTB.add_handler(STARE_HANDLER)
SHIKIMORI_PTB.add_handler(THINK_HANDLER)
SHIKIMORI_PTB.add_handler(THUMBSUP_HANDLER)

SHIKIMORI_PTB.add_handler(SLAP_HANDLER)
SHIKIMORI_PTB.add_handler(KILLGIF_HANDLER)
SHIKIMORI_PTB.add_handler(HAPPY_HANDLER)
SHIKIMORI_PTB.add_handler(WINK_HANDLER)
SHIKIMORI_PTB.add_handler(POKE_HANDLER)
SHIKIMORI_PTB.add_handler(DANCE_HANDLER)
SHIKIMORI_PTB.add_handler(CRINGE_HANDLER)


SHIKIMORI_PTB.add_handler(SMUG_HANDLER)
SHIKIMORI_PTB.add_handler(BONK_HANDLER)
SHIKIMORI_PTB.add_handler(YEET_HANDLER)
SHIKIMORI_PTB.add_handler(BLUSH_HANDLER)
SHIKIMORI_PTB.add_handler(SMILE_HANDLER)
SHIKIMORI_PTB.add_handler(WAVE_HANDLER)
SHIKIMORI_PTB.add_handler(HIGHFIVE_HANDLER)
SHIKIMORI_PTB.add_handler(HANDHOLD_HANDLER)
SHIKIMORI_PTB.add_handler(NOM_HANDLER)
SHIKIMORI_PTB.add_handler(BITE_HANDLER)
SHIKIMORI_PTB.add_handler(GLOMP_HANDLER)




SHIKIMORI_PTB.add_handler(AWOO_HANDLER)
SHIKIMORI_PTB.add_handler(PAT_HANDLER)
SHIKIMORI_PTB.add_handler(KISS_HANDLER)
SHIKIMORI_PTB.add_handler(LICK_HANDLER)
SHIKIMORI_PTB.add_handler(CRY_HANDLER)
SHIKIMORI_PTB.add_handler(HUG_HANDLER)
SHIKIMORI_PTB.add_handler(WAIFUS_HANDLER)
SHIKIMORI_PTB.add_handler(NEKO_HANDLER)
SHIKIMORI_PTB.add_handler(SHINOBU_HANDLER)
SHIKIMORI_PTB.add_handler(MEGUMIN_HANDLER)
SHIKIMORI_PTB.add_handler(BULLY_HANDLER)
SHIKIMORI_PTB.add_handler(CUDDLE_HANDLER)

SHIKIMORI_PTB.add_handler(LIZARD_HANDLER)
SHIKIMORI_PTB.add_handler(NGIF_HANDLER)
SHIKIMORI_PTB.add_handler(GOOSE_HANDLER)
SHIKIMORI_PTB.add_handler(WOOF_HANDLER)
SHIKIMORI_PTB.add_handler(GECG_HANDLER)
SHIKIMORI_PTB.add_handler(WALLPAPER_HANDLER)
SHIKIMORI_PTB.add_handler(TICKLE_HANDLER)
SHIKIMORI_PTB.add_handler(FEED_HANDLER)
SHIKIMORI_PTB.add_handler(GASM_HANDLER)
SHIKIMORI_PTB.add_handler(AVATAR_HANDLER)
SHIKIMORI_PTB.add_handler(FOXGIRL_HANDLER)
