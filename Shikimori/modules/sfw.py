...
app_build.add_handler(WAIFU_HANDLER)
SWAIFU_HANDLER = CommandHandler('swaifu', swaifu, block=False)
app_build.add_handler(SWAIFU_HANDLER)
SOURCE_HANDLER = CommandHandler('source', source, block=False)
app_build.add_handler(SOURCE_HANDLER)
app_build.add_handler(POUT_HANDLER)
app_build.add_handler(BORED_HANDLER)
app_build.add_handler(NEKOS_HANDLER)
app_build.add_handler(STARE_HANDLER)
app_build.add_handler(THINK_HANDLER)
app_build.add_handler(THUMBSUP_HANDLER)

app_build.add_handler(SLAP_HANDLER)
app_build.add_handler(KILLGIF_HANDLER)
app_build.add_handler(HAPPY_HANDLER)
app_build.add_handler(WINK_HANDLER)
app_build.add_handler(POKE_HANDLER)
app_build.add_handler(DANCE_HANDLER)
app_build.add_handler(CRINGE_HANDLER)


app_build.add_handler(SMUG_HANDLER)
app_build.add_handler(BONK_HANDLER)
app_build.add_handler(YEET_HANDLER)
app_build.add_handler(BLUSH_HANDLER)
app_build.add_handler(SMILE_HANDLER)
app_build.add_handler(WAVE_HANDLER)
app_build.add_handler(HIGHFIVE_HANDLER)
app_build.add_handler(HANDHOLD_HANDLER)
app_build.add_handler(NOM_HANDLER)
app_build.add_handler(BITE_HANDLER)
app_build.add_handler(GLOMP_HANDLER)




app_build.add_handler(AWOO_HANDLER)
app_build.add_handler(PAT_HANDLER)
app_build.add_handler(KISS_HANDLER)
app_build.add_handler(LICK_HANDLER)
app_build.add_handler(CRY_HANDLER)
app_build.add_handler(HUG_HANDLER)
app_build.add_handler(WAIFUS_HANDLER)
app_build.add_handler(NEKO_HANDLER)
app_build.add_handler(SHINOBU_HANDLER)
app_build.add_handler(MEGUMIN_HANDLER)
app_build.add_handler(BULLY_HANDLER)
app_build.add_handler(CUDDLE_HANDLER)

app_build.add_handler(LIZARD_HANDLER)
app_build.add_handler(NGIF_HANDLER)
app_build.add_handler(GOOSE_HANDLER)
app_build.add_handler(WOOF_HANDLER)
app_build.add_handler(GECG_HANDLER)
app_build.add_handler(WALLPAPER_HANDLER)
app_build.add_handler(TICKLE_HANDLER)
app_build.add_handler(FEED_HANDLER)
app_build.add_handler(GASM_HANDLER)
app_build.add_handler(AVATAR_HANDLER)
app_build.add_handler(FOXGIRL_HANDLER)
