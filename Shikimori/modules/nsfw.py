...
NSFWWAIFU_HANDLER = CommandHandler(("nsfwwaifu", "nwaifu"), nsfwwaifu, block=False)
BLOWJOB_HANDLER = CommandHandler(("blowjob", "bj"), blowjob, block=False)
...
SHIKIMORI_PTB.add_handler(ADD_NSFW_HANDLER)
SHIKIMORI_PTB.add_handler(REMOVE_NSFW_HANDLER)
SHIKIMORI_PTB.add_handler(LIST_NSFW_CHATS_HANDLER)
SHIKIMORI_PTB.add_handler(NSFWWAIFU_HANDLER)
SHIKIMORI_PTB.add_handler(BLOWJOB_HANDLER)
SHIKIMORI_PTB.add_handler(SPANK_HANDLER)
SHIKIMORI_PTB.add_handler(TRAP_HANDLER)
SHIKIMORI_PTB.add_handler(NSFWNEKO_HANDLER)
