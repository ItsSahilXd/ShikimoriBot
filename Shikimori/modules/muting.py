...
from Shikimori import LOGGER, TIGERS, SHIKIMORI_PTB
...
@user_admin
@loggable
def mute(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
...
@user_admin
@loggable
def unmute(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    bot, args = context.bot, context.args
    chat = update.effective_chat
    user = update.effective_user
    message = update.effective_message
...
@user_admin
@loggable
def temp_mute(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    bot, args = context.bot, context.args
    chat = update.effective_chat
    user = update.effective_user
    message = update.effective_message
...
SHIKIMORI_PTB.add_handler(MUTE_HANDLER)
SHIKIMORI_PTB.add_handler(UNMUTE_HANDLER)
SHIKIMORI_PTB.add_handler(TEMPMUTE_HANDLER)
SHIKIMORI_PTB.add_handler(UNMUTE_BUTTON_HANDLER)
